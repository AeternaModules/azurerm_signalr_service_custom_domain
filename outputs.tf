output "signalr_service_custom_domains_id" {
  ...
  value       = { for k, v in azurerm_signalr_service_custom_domain.signalr_service_custom_domains : k => v.id if v.id != null && length(v.id) > 0 }
}
output "signalr_service_custom_domains_domain_name" {
  ...
  value       = { for k, v in azurerm_signalr_service_custom_domain.signalr_service_custom_domains : k => v.domain_name if v.domain_name != null && length(v.domain_name) > 0 }
}
output "signalr_service_custom_domains_name" {
  ...
  value       = { for k, v in azurerm_signalr_service_custom_domain.signalr_service_custom_domains : k => v.name if v.name != null && length(v.name) > 0 }
}
output "signalr_service_custom_domains_signalr_custom_certificate_id" {
  ...
  value       = { for k, v in azurerm_signalr_service_custom_domain.signalr_service_custom_domains : k => v.signalr_custom_certificate_id if v.signalr_custom_certificate_id != null && length(v.signalr_custom_certificate_id) > 0 }
}
output "signalr_service_custom_domains_signalr_service_id" {
  ...
  value       = { for k, v in azurerm_signalr_service_custom_domain.signalr_service_custom_domains : k => v.signalr_service_id if v.signalr_service_id != null && length(v.signalr_service_id) > 0 }
}
